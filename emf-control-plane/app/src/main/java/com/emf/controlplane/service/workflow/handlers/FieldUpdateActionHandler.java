 ...
 * </pre>
 * <p>
 * The handler computes the field updates from the config and applies them
 * to the triggering record's data. The updated fields are returned in the
 * {@link ActionResult#outputData()} for downstream use.
 */
@Component
