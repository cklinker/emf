 ...
 *   "message": "Order has been approved and is ready for processing.",
 *   "level": "INFO"
 * }
 * </pre>
 * <p>
 * If {@code userId} is not specified, the notification is sent to the user who
 * triggered the workflow. Level defaults to "INFO" and can be INFO, WARNING, or ERROR.
 */
@Component
