...
class GatewayMetricsTest {
    ...
    @Nested
    @DisplayName("emf.gateway.requests (Timer)")
    class RequestTimer {
        ...
        void shouldRecordRequestDuration() {
            ...
            Timer timer = registry.find("emf.gateway.requests")
                    .tag("tenant", "acme")
                    .tag("method", "GET")
                    .tag("status", "200")
                    .tag("route", "users")
        ...
        void shouldSeparateByTenant() {
            ...
            Timer acmeTimer = registry.find("emf.gateway.requests")
                    .tag("tenant", "acme").timer();
            Timer globexTimer = registry.find("emf.gateway.requests")
    ...
    @Nested
    @DisplayName("emf.gateway.requests.active (Gauge)")
    class ActiveRequestsGauge {
        ...
        void shouldIncrementAndDecrement() {
            ...
            Gauge gauge = registry.find("emf.gateway.requests.active")
        ...
        void shouldSeparateByTenant() {
            ...
            Gauge acmeGauge = registry.find("emf.gateway.requests.active")
                    .tag("tenant", "acme").gauge();
            Gauge globexGauge = registry.find("emf.gateway.requests.active")
    ...
    @Nested
    @DisplayName("emf.gateway.auth.failures (Counter)")
    class AuthFailuresCounter {
        ...
        void shouldRecordAuthFailure() {
            ...
            Counter counter = registry.find("emf.gateway.auth.failures")
                    .tag("tenant", "acme")
        ...
        void shouldSeparateByReason() {
            ...
            Counter missing = registry.find("emf.gateway.auth.failures")
                    .tag("reason", "missing_token").counter();
            Counter invalid = registry.find("emf.gateway.auth.failures")
    ...
    @Nested
    @DisplayName("emf.gateway.authz.denied (Counter)")
    class AuthzDeniedCounter {
        ...
        void shouldRecordAuthzDenied() {
            ...
            Counter counter = registry.find("emf.gateway.authz.denied")
                    .tag("tenant", "acme")
                    .tag("route", "users")
                    .tag("method", "DELETE")
                    .counter();
    ...
    @Nested
    @DisplayName("emf.gateway.ratelimit.exceeded (Counter)")
    class RateLimitExceededCounter {
        ...
        void shouldRecordRateLimitExceeded() {
            ...
            Counter counter = registry.find("emf.gateway.ratelimit.exceeded")
                    .tag("tenant", "acme")
                    .counter();
    ...
    @Nested
    @DisplayName("emf.gateway.ratelimit.remaining.ratio (Gauge)")
    class RateLimitRemainingGauge {
        ...
        void shouldRecordRemainingRatio() {
            ...
            Gauge gauge = registry.find("emf.gateway.ratelimit.remaining.ratio")
                    .tag("tenant", "acme").gauge();
    ...
    @Nested
    @DisplayName("emf.gateway.permissions.resolve (Timer)")
    class PermissionsResolveTimer {
        ...
        void shouldRecordCacheHit() {
            ...
            Timer timer = registry.find("emf.gateway.permissions.resolve")
    ...
    @Nested
    @DisplayName("emf.gateway.tenant.resolution (Counter)")
    class TenantResolutionCounter {
        ...
        void shouldRecordSlugSuccess() {
            ...
            Counter counter = registry.find("emf.gateway.tenant.resolution")
                    .tag("method", "slug")
                    .tag("result", "success")
                    .counter();
    ...
    @Nested
    @DisplayName("emf.gateway.errors (Counter)")
    class ErrorsCounter {
        ...
        void shouldRecordError() {
            ...
            Counter counter = registry.find("emf.gateway.errors")
                    .tag("tenant", "acme")
                    .tag("status", "401")
        ...
        void shouldSeparateByErrorCode() {
            ...
            assertThat(registry.find("emf.gateway.errors")
