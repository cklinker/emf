 ...
 *
 * @param minValue Minimum value for numeric fields (INTEGER, LONG, DOUBLE, CURRENCY, PERCENT)
 * @param maxValue Maximum value for numeric fields (INTEGER, LONG, DOUBLE, CURRENCY, PERCENT)
...
public record ValidationRules(
     ...
     */
    public static ValidationRules forNumeric(Double minValue, Double maxValue) {
