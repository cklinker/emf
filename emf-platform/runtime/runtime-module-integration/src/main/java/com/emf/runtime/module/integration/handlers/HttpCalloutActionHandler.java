 ...
 * </pre>
 *
 * <p>The response body is captured and available via {@code responseVariable}
 * for downstream actions in the workflow. Max response size is 50KB.
 *
 * @since 1.0.0
 */
public class HttpCalloutActionHandler implements ActionHandler {
    ...
    public HttpCalloutActionHandler(ObjectMapper objectMapper, RestTemplate restTemplate) {
