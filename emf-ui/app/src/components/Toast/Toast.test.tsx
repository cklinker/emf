...
import { Toast, ToastProvider, useToast, DEFAULT_DURATION } from './Toast'
...
function TestComponent() {
  ...
  return (
    <div>
      ...
      <button data-testid="show-warning" onClick={() => showToast('Warning message', 'warning')}>
        Show Warning
      </button>
      <button data-testid="show-info" onClick={() => showToast('Info message', 'info')}>
        Show Info
      </button>
      <button
