...
function getThemeColors(
  ...
  return {
    ...
    primaryHover: adjustColor(themeConfig.primaryColor || baseColors.primary, resolvedMode === 'dark' ? 10 : -10),
    primaryActive: adjustColor(themeConfig.primaryColor || baseColors.primary, resolvedMode === 'dark' ? 20 : -20),
    secondary: themeConfig.secondaryColor || baseColors.secondary,
    secondaryHover: adjustColor(themeConfig.secondaryColor || baseColors.secondary, resolvedMode === 'dark' ? 10 : -10),
    secondaryActive: adjustColor(themeConfig.secondaryColor || baseColors.secondary, resolvedMode === 'dark' ? 20 : -20),
  };
}
