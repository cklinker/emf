...
describe('useKeyboardShortcuts', () => {
  ...
  describe('Basic Functionality', () => {
    it('should call handler when matching key is pressed', () => {
      const handler = vi.fn()
      const shortcuts: KeyboardShortcut[] = [{ key: 'k', handler }]
  ...
  describe('Modifier Keys', () => {
    it('should require Ctrl modifier when specified', () => {
      const handler = vi.fn()
      const shortcuts: KeyboardShortcut[] = [{ key: 'k', modifiers: { ctrl: true }, handler }]
    ...
    it('should require Alt modifier when specified', () => {
      const handler = vi.fn()
      const shortcuts: KeyboardShortcut[] = [{ key: 'k', modifiers: { alt: true }, handler }]
    ...
    it('should require Shift modifier when specified', () => {
      const handler = vi.fn()
      const shortcuts: KeyboardShortcut[] = [{ key: 'k', modifiers: { shift: true }, handler }]
    ...
    it('should require Meta modifier when specified', () => {
      const handler = vi.fn()
      const shortcuts: KeyboardShortcut[] = [{ key: 'k', modifiers: { meta: true }, handler }]
  ...
  describe('Input Element Handling', () => {
    ...
    it('should trigger shortcuts in input when allowInInput is true', () => {
      const handler = vi.fn()
      const shortcuts: KeyboardShortcut[] = [{ key: 'Escape', handler, allowInInput: true }]
  ...
  describe('preventDefault', () => {
    it('should prevent default when preventDefault is true', () => {
      const handler = vi.fn()
      const shortcuts: KeyboardShortcut[] = [{ key: 'k', handler, preventDefault: true }]
    ...
    it('should not prevent default when preventDefault is false', () => {
      const handler = vi.fn()
      const shortcuts: KeyboardShortcut[] = [{ key: 'k', handler, preventDefault: false }]
