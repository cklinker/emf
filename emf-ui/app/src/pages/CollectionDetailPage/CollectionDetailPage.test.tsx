...
function TestWrapper({ children, initialEntries = ['/collections/users'] }: { 
...
describe('CollectionDetailPage', () => {
  ...
  describe('Collection Metadata Display', () => {
    ...
    it('should display collection description when present', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId('collection-description')).toHaveTextContent('User accounts collection');
      });
    });
  ...
  describe('Authorization Configuration Display', () => {
    ...
    it('should display empty state when no route policies', async () => {
      const collectionNoAuthz = { ...mockCollection, authz: { routePolicies: [], fieldPolicies: [] } };
