...
describe('MigrationsPage', () => {
  ...
  describe('Migration Plan Display - Requirements 10.3, 10.4', () => {
    ...
    it('displays risk descriptions', async () => {
      ...
      expect(screen.getByText(/Adding new field may increase storage requirements/)).toBeInTheDocument();
      expect(screen.getByText(/Index creation may temporarily slow down writes/)).toBeInTheDocument();
  ...
  describe('Migration Execution - Requirements 10.5, 10.6, 10.7', () => {
    ...
    function setupExecutionHandlers(options: {
