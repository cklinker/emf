...
const mockResources: Resource[] = [
  { id: 'r1', name: 'John Doe', email: 'john@example.com', age: 30, active: true, createdAt: '2024-01-15T10:00:00Z' },
  { id: 'r2', name: 'Jane Smith', email: 'jane@example.com', age: 25, active: false, createdAt: '2024-01-16T11:00:00Z' },
  { id: 'r3', name: 'Bob Wilson', email: 'bob@example.com', age: 35, active: true, createdAt: '2024-01-17T12:00:00Z' },
];
  ...
  describe('Export Utility Functions - Requirement 11.12', () => {
    ...
    describe('recordsToCSV', () => {
      ...
      it('should handle null/undefined field values', () => {
        const recordsWithNulls: Resource[] = [
          { id: 'r1', name: null, email: undefined },
        ];
