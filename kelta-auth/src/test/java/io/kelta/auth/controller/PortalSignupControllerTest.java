...
class PortalSignupControllerTest {
    ...
    void setUp() {
        ...
        controller = new PortalSignupController(portalLoginService, domainResolver, workerClient);
    ...
    private ResponseEntity<Map<String, String>> signup(String email, String tenant,
        ...
        return controller.signup(
                new PortalSignupController.SignupRequest(email, tenant, redirectUri, null, null),
                httpRequest());
    }
