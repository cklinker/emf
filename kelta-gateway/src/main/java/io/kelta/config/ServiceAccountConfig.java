...
public class ServiceAccountConfig {
    ...
    @Value("${kelta.gateway.service-account.client-id:kelta-gateway-service}")
    private String clientId;
    
    @Value("${kelta.gateway.service-account.client-secret:kelta-gateway-service-secret}")
    ...
    public ReactiveClientRegistrationRepository clientRegistrationRepository() {
        ClientRegistration registration = ClientRegistration
            .withRegistrationId("kelta-gateway-service")
            .clientId(clientId)
