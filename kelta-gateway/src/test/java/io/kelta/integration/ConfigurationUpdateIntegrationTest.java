...
public class ConfigurationUpdateIntegrationTest extends IntegrationTestBase {
     ...
     * Subscribes to kelta.config.collection.changed topic.
     */
    private void setupKafkaConsumer() {
        ...
        kafkaConsumer.subscribe(Collections.singletonList("kelta.config.collection.changed"));
        ...
        while (!eventFound && (System.currentTimeMillis() - startTime) < timeout) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                if (payload != null && collectionId.equals(payload.get("id"))) {
                    ...
                    assertThat(event.get("eventType")).isEqualTo("kelta.config.collection.changed");
