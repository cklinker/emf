...
public class DeactivatePicklistValueTool implements AdminTool {
    ...
    public SyncToolSpecification toSpecification() {
        ...
        Tool tool = Tool.builder()
                ...
                .description("Mark a picklist value inactive without deleting it (existing records keep the value, but it is no longer selectable). PATCHes /api/picklist-values/{id} with isActive=false.")
