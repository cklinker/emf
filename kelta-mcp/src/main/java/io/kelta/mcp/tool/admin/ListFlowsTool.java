...
@Component
public class ListFlowsTool implements AdminTool {

    private final GatewayHttpClient gateway;

    public ListFlowsTool(GatewayHttpClient gateway) {
    ...
    public SyncToolSpecification toSpecification() {
        ...
        properties.put("name", Schemas.string(
                "Optional exact-match filter on flow name. Omit to list all flows in the tenant."));
        ...
        Tool tool = Tool.builder()
                .name("list_flows")
                .title("List Flows")
                .description("List automation flows. Wraps GET /api/flows. With a name filter (filter[name][EQ]=…) this is the idempotent existence check that setup scripts use before deciding whether to create_flow.")
        ...
        return SyncToolSpecification.builder()
                ...
                .callHandler((context, request) -> {
                    ...
                    StringBuilder path = new StringBuilder("/api/flows?page[size]=").append(pageSize);
