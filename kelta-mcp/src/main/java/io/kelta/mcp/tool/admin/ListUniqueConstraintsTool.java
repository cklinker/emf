...
public class ListUniqueConstraintsTool implements AdminTool {
    ...
    public SyncToolSpecification toSpecification() {
        ...
        properties.put("collectionName", Schemas.string(
                "Collection name whose unique constraints to list."));

        Tool tool = Tool.builder()
                .name("list_unique_constraints")
                .title("List Unique Constraints")
                .description("List all composite unique constraints on a collection. Returns the index name and participating field names for each constraint. Wraps GET /api/admin/collections/{name}/unique-constraints.")
        ...
        return SyncToolSpecification.builder()
                ...
                .callHandler((context, request) -> {
                    ...
                    try {
                        return McpErrorMapper.toResult(gateway.get(
