 ...
 * <ul>
 *   <li>{@link io.kelta.runtime.storage.StorageAdapter} for persistence</li>
 *   <li>{@link io.kelta.runtime.validation.ValidationEngine} for data validation</li>
 ...
 * @see QueryRequest
 * @see QueryResult
 * @see io.kelta.runtime.storage.StorageAdapter
 * @since 1.0.0
 */
public interface QueryEngine {
     ...
     * @throws io.kelta.runtime.storage.StorageException if the lookup fails
     */
     ...
     * @throws io.kelta.runtime.validation.ValidationException if validation fails
     * @throws io.kelta.runtime.storage.StorageException if the create operation fails
     * @throws io.kelta.runtime.storage.UniqueConstraintViolationException if a unique constraint is violated
     */
     ...
     * @throws io.kelta.runtime.validation.ValidationException if validation fails
     * @throws io.kelta.runtime.storage.StorageException if the update operation fails
     * @throws io.kelta.runtime.storage.UniqueConstraintViolationException if a unique constraint is violated
     */
     ...
     * @throws io.kelta.runtime.storage.StorageException if the delete operation fails
     */
