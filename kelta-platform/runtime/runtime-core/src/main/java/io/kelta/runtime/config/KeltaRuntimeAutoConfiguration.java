...
import io.kelta.runtime.validation.ValidationRuleEvaluator;
 ...
 * 
 * <p>Provides default bean configurations for all Kelta runtime components:
 * <ul>
 ...
 */
@Configuration
@EnableConfigurationProperties(KeltaRuntimeProperties.class)
@ComponentScan(basePackages = "io.kelta.runtime")
public class KeltaRuntimeAutoConfiguration {
     ...
     */
    @Bean("keltaRuntimeGlobalExceptionHandler")
     ...
     */
    @Bean
    @ConditionalOnMissingBean(name = "keltaTomcatCustomizer")
    public WebServerFactoryCustomizer<TomcatServletWebServerFactory> keltaTomcatCustomizer() {
