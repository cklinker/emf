package io.kelta.runtime.integration;
...
/**
 * Integration tests for Kelta Runtime Core.
 * 
 * <p>Tests the full flow: create collection → create record → query → update → delete.
 * Uses an embedded H2 database for testing.
 */
@DisplayName("Kelta Runtime Integration Tests")
class KeltaRuntimeIntegrationTest {
    ...
    class ValidationTests {
        ...
        void shouldValidateRequiredFields() {
            ...
            assertThrows(io.kelta.runtime.validation.ValidationException.class, () ->
