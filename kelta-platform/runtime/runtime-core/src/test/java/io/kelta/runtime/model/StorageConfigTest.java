 ...
 *
 * Validates: Requirements 1.1 - Storage configuration
 */
...
class StorageConfigTest {
    ...
    class ConstructorTests {
        ...
        void shouldCreateWithAllParameters() {
            ...
            StorageConfig config = new StorageConfig("tbl_test", adapterConfig);
        ...
        void shouldDefaultToEmptyMapWhenAdapterConfigIsNull() {
            StorageConfig config = new StorageConfig("tbl_test", null);
        ...
        void shouldPerformDefensiveCopyOfAdapterConfig() {
            ...
            StorageConfig config = new StorageConfig("tbl_test", mutableMap);
        ...
        void shouldReturnImmutableAdapterConfig() {
            StorageConfig config = new StorageConfig("tbl_test", Map.of("key", "value"));
    ...
    class FactoryMethodTests {
        ...
        @Test
        @DisplayName("physicalTable() should create config with table name")
        void physicalTableShouldCreateConfig() {
    ...
    class EqualityTests {
        ...
        void shouldBeEqualWhenFieldsMatch() {
            StorageConfig config1 = new StorageConfig("tbl_test", Map.of("key", "value"));
            StorageConfig config2 = new StorageConfig("tbl_test", Map.of("key", "value"));
        ...
        void shouldNotBeEqualWhenFieldsDiffer() {
            StorageConfig config1 = new StorageConfig("tbl_test", Map.of());
            StorageConfig config2 = new StorageConfig("tbl_other", Map.of());
