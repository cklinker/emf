...
import io.kelta.runtime.workflow.*;
...
class ModuleRegistryTest {
    ...
    void shouldRegisterModuleWithActionHandlers() {
        KeltaModule module = createModule("test-module", "Test Module", "1.0.0",
    ...
    void shouldInitializeMultipleModules() {
        ...
        KeltaModule m1 = new KeltaModule() {
        ...
        KeltaModule m2 = new KeltaModule() {
    ...
    void shouldCallOnStartupBeforeRegisteringHandlers() {
        ...
        KeltaModule lazyModule = new KeltaModule() {
    ...
    void shouldPassContextWithActionHandlerRegistryToOnStartup() {
        ...
        KeltaModule module = new KeltaModule() {
    ...
    void shouldHandleStartupExceptions() {
        KeltaModule failingModule = new KeltaModule() {
    ...
    void shouldReplaceDuplicateModule() {
        KeltaModule m1 = createModule("dup", "Module V1", "1.0", List.of(), List.of());
        KeltaModule m2 = createModule("dup", "Module V2", "2.0", List.of(), List.of());
    ...
    private KeltaModule createModule(String id, String name, String version,
                                    List<ActionHandler> handlers,
                                    List<BeforeSaveHook> hooks) {
        return new KeltaModule() {
