...
function TestConsumer({
  ...
  onRender?: (context: ReturnType<typeof useAppShell>) => void
}) {
  ...
  return (
    <div>
      ...
      <button onClick={context.toggleMobileSidebar} data-testid="toggle-mobile">
        Toggle Mobile
      </button>
      <button onClick={context.closeMobileSidebar} data-testid="close-mobile">
        Close Mobile
      </button>
    </div>
  )
