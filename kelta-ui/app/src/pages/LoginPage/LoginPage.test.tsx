  ...
  return (
    <MemoryRouter initialEntries={['/login']}>
      <Routes>
        ...
        <Route path="/default/app" element={<div data-testid="dashboard">Dashboard</div>} />
      </Routes>
    </MemoryRouter>
  )
}
...
describe('LoginPage', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should display the application name from config', () => {
      ...
      expect(screen.getByText('Kelta Admin')).toBeInTheDocument()
    })
    ...
    it('should display the logo from config', () => {
      ...
      const logo = screen.getByAltText('Kelta Admin')
