...
import type { CreatePermissionSetRequest, UpdatePermissionSetRequest } from '@kelta/sdk'
...
export function PermissionSetsPage({
  ...
  const {
    ...
    queryFn: () => keltaClient.admin.permissionSets.list() as Promise<PermissionSet[]>,
  })
  ...
  const createMutation = useMutation({
    mutationFn: (data: PermissionSetFormData) =>
      keltaClient.admin.permissionSets.create(
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: PermissionSetFormData }) =>
      keltaClient.admin.permissionSets.update(
        id,
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) => keltaClient.admin.permissionSets.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['permission-sets'] })
