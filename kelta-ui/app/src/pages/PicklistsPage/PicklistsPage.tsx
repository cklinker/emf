...
import type { CreateGlobalPicklistRequest } from '@kelta/sdk'
...
export function PicklistsPage({
  ...
  const {
    ...
    queryKey: ['picklists'],
    queryFn: () => keltaClient.admin.picklists.listGlobal() as Promise<GlobalPicklist[]>,
  })
  ...
  const createMutation = useMutation({
    mutationFn: (data: PicklistFormData) =>
      keltaClient.admin.picklists.createGlobal(
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: PicklistFormData }) =>
      keltaClient.admin.picklists.updateGlobal(
        id,
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) => keltaClient.admin.picklists.deleteGlobal(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['picklists'] })
