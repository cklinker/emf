...
import type { CreateReportRequest } from '@kelta/sdk'
...
export function ReportsPage({ testId = 'reports-page' }: ReportsPageProps): React.ReactElement {
  ...
  const {
    ...
    queryKey: ['reports'],
    queryFn: () => keltaClient.admin.reports.list() as Promise<Report[]>,
  })
  ...
  const createMutation = useMutation({
    mutationFn: (data: Record<string, unknown>) =>
      keltaClient.admin.reports.create('', '', data as CreateReportRequest) as Promise<Report>,
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: Record<string, unknown> }) =>
      keltaClient.admin.reports.update(id, data as Partial<CreateReportRequest>) as Promise<Report>,
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) => keltaClient.admin.reports.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['reports'] })
