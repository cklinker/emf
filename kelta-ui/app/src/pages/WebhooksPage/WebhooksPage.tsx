...
import type { CreateWebhookRequest } from '@kelta/sdk'
...
export function WebhooksPage({ testId = 'webhooks-page' }: WebhooksPageProps): React.ReactElement {
  ...
  const {
    ...
    queryFn: () => keltaClient.admin.webhooks.listDeliveries(logsItemId!),
    enabled: !!logsItemId,
  })
  ...
  const {
    ...
    queryKey: ['webhooks'],
    queryFn: () => keltaClient.admin.webhooks.list(),
  })
  ...
  const createMutation = useMutation({
    mutationFn: (data: WebhookFormData) => {
      ...
      return keltaClient.admin.webhooks.create('', '', payload as unknown as CreateWebhookRequest)
    },
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: WebhookFormData }) => {
      ...
      return keltaClient.admin.webhooks.update(
        id,
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) => keltaClient.admin.webhooks.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['webhooks'] })
