...
describe('Visual Accessibility', () => {
  ...
  describe('Alt Text for Non-Text Content (Requirement 14.8)', () => {
    ...
    it('decorative images should have empty alt attribute', () => {
      render(<img src="/decorative.png" alt="" aria-hidden="true" data-testid="decorative-image" />)
    ...
    it('icons should have aria-label or be hidden from screen readers', () => {
      render(
        <>
          <span role="img" aria-label="Warning icon" data-testid="labeled-icon">
            ⚠️
          </span>
          <span aria-hidden="true" data-testid="hidden-icon">
            🔧
          </span>
        </>
      )
