...
describe('PageLayout', () => {
  ...
  describe('Custom Styling (Requirement 16.5)', () => {
    it('should apply custom className', () => {
      ...
      expect(screen.getByTestId('kelta-page-layout')).toHaveClass('custom-layout');
    });
    ...
    it('should apply custom style', () => {
      ...
      const layout = screen.getByTestId('kelta-page-layout');
...
describe('TwoColumnLayout', () => {
  describe('Basic Rendering (Requirement 16.2)', () => {
    ...
    it('should render sidebar on left by default', () => {
      ...
      const layout = screen.getByTestId('kelta-two-column-layout');
      expect(layout).toHaveClass('kelta-two-column-layout--sidebar-left');
    ...
    it('should render sidebar on right when specified', () => {
      ...
      const layout = screen.getByTestId('kelta-two-column-layout');
      expect(layout).toHaveClass('kelta-two-column-layout--sidebar-right');
  ...
  describe('Responsive Behavior (Requirement 16.4)', () => {
    it('should apply collapsible class when enabled', () => {
      ...
      expect(screen.getByTestId('kelta-two-column-layout')).toHaveClass(
        'kelta-two-column-layout--collapsible'
      );
    });
    ...
    it('should not apply collapsible class when disabled', () => {
      ...
      expect(screen.getByTestId('kelta-two-column-layout')).not.toHaveClass(
        'kelta-two-column-layout--collapsible'
      );
    });
  ...
  describe('Custom Styling (Requirement 16.5)', () => {
    it('should apply custom className', () => {
      ...
      expect(screen.getByTestId('kelta-two-column-layout')).toHaveClass('custom-two-column');
    });
    ...
    it('should apply custom style', () => {
      ...
      expect(screen.getByTestId('kelta-two-column-layout')).toHaveStyle({ gap: '20px' });
    });
...
describe('ThreeColumnLayout', () => {
  describe('Basic Rendering (Requirement 16.3)', () => {
    ...
    it('should render content in correct order', () => {
      ...
      const layout = screen.getByTestId('kelta-three-column-layout');
      const children = layout.children;

      expect(children[0]).toHaveClass('kelta-three-column-layout__left');
      expect(children[1]).toHaveClass('kelta-three-column-layout__main');
      expect(children[2]).toHaveClass('kelta-three-column-layout__right');
    });
  });
  ...
  describe('Responsive Behavior (Requirement 16.4)', () => {
    it('should apply collapsible class when enabled', () => {
      ...
      expect(screen.getByTestId('kelta-three-column-layout')).toHaveClass(
        'kelta-three-column-layout--collapsible'
      );
    });
    ...
    it('should not apply collapsible class when disabled', () => {
      ...
      expect(screen.getByTestId('kelta-three-column-layout')).not.toHaveClass(
        'kelta-three-column-layout--collapsible'
      );
    });
  ...
  describe('Custom Styling (Requirement 16.5)', () => {
    it('should apply custom className', () => {
      ...
      expect(screen.getByTestId('kelta-three-column-layout')).toHaveClass('custom-three-column');
    });
    ...
    it('should apply custom style', () => {
      ...
      expect(screen.getByTestId('kelta-three-column-layout')).toHaveStyle({ padding: '10px' });
    });
