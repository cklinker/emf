...
import type { PageLayout, FieldDefinition, LayoutSection, LayoutRelatedList } from '@kelta/sdk';
...
describe('LayoutRenderer', () => {
  describe('Basic View Mode Rendering', () => {
    it('should render sections and field values in view mode', () => {
      ...
      expect(screen.getByTestId('kelta-layout-renderer')).toBeInTheDocument();
    ...
    it('should apply view mode class', () => {
      ...
      const container = screen.getByTestId('kelta-layout-renderer');
      expect(container).toHaveClass('kelta-layout-renderer--view');
    });
  ...
  describe('Basic Edit Mode Rendering', () => {
    ...
    it('should apply edit mode class', () => {
      ...
      const container = screen.getByTestId('kelta-layout-renderer');
      expect(container).toHaveClass('kelta-layout-renderer--edit');
    });
  ...
  describe('Multi-Column Section Rendering', () => {
    it('should render fields grouped into the correct number of columns', () => {
      ...
      const sectionBody = screen
        .getByTestId('layout-section-sec-1')
        .querySelector('.kelta-layout-renderer__section-body');
      expect(sectionBody).toBeInTheDocument();

      const columns = sectionBody!.querySelectorAll('.kelta-layout-renderer__column');
    ...
    it('should place fields in column 0 when columnNumber is within range', () => {
      ...
      const columns = screen
        .getByTestId('layout-section-sec-1')
        .querySelectorAll('.kelta-layout-renderer__column');
  ...
  describe('Highlights Panel Rendering', () => {
    it('should render highlights panel section before other sections', () => {
      ...
      const container = screen.getByTestId('kelta-layout-renderer');
      const sections = container.querySelectorAll('.kelta-layout-renderer__section');

      // Highlights panel should come first regardless of sort order
      expect(sections[0]).toHaveClass('kelta-layout-renderer__section--highlights');
    });
    ...
    it('should apply highlights class to highlights panel section', () => {
      ...
      expect(section).toHaveClass('kelta-layout-renderer__section--highlights');
    });
    ...
    it('should not include highlights panel in standalone sections list', () => {
      ...
      const allSections = screen.getByTestId('kelta-layout-renderer').querySelectorAll('section');
  ...
  describe('Collapsible Section Toggling', () => {
    ...
    it('should apply collapsible class to section', () => {
      ...
      expect(section).toHaveClass('kelta-layout-renderer__section--collapsible');
    });
  ...
  describe('Related List Rendering', () => {
    ...
    it('should render multiple related lists in sort order', () => {
      ...
      const lists = relatedListContainer.querySelectorAll('.kelta-layout-renderer__related-list');
  ...
  describe('Custom Styling and Test ID', () => {
    it('should apply custom className', () => {
      ...
      expect(screen.getByTestId('kelta-layout-renderer')).toHaveClass('custom-class');
    });
  ...
  describe('Card Style Section', () => {
    it('should apply card class to card-style sections', () => {
      ...
      expect(section).toHaveClass('kelta-layout-renderer__section--card');
    });
  });
