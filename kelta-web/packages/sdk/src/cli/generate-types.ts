 ...
 *
 * Usage:
 *   npx @kelta/sdk generate-types --url <openapi-url> --output <output-file>
 *   npx @kelta/sdk generate-types -u http://localhost:8080/openapi.json -o ./src/types/api.ts
 */
...
export function printHelp(): void {
  ...
  console.log(`
Kelta Type Generator - Generate TypeScript types from OpenAPI specifications
...
const isMainModule =
  ...
  (process.argv[1].endsWith('generate-types.ts') ||
    ...
    process.argv[1].includes('@kelta/sdk'));
