...
describe('Error Class Hierarchy', () => {
  describe('KeltaError (Base Class)', () => {
    it('should create an error with message only', () => {
      const error = new KeltaError('Something went wrong');

      expect(error).toBeInstanceOf(Error);
      expect(error).toBeInstanceOf(KeltaError);
      expect(error.message).toBe('Something went wrong');
      expect(error.name).toBe('KeltaError');
      expect(error.statusCode).toBeUndefined();
      expect(error.details).toBeUndefined();
    });

    it('should create an error with message and status code', () => {
      const error = new KeltaError('Bad request', 400);
    ...
    it('should create an error with message, status code, and details', () => {
      ...
      const error = new KeltaError('Validation failed', 400, details);
    ...
    it('should preserve prototype chain for instanceof checks', () => {
      const error = new KeltaError('Test error');

      expect(error instanceof Error).toBe(true);
      expect(error instanceof KeltaError).toBe(true);
    });
  });
  ...
  describe('parseErrorResponse', () => {
    ...
    it('should return generic KeltaError for other status codes', () => {
  ...
  describe('mapAxiosError', () => {
    ...
    it('should map regular Error to KeltaError', () => {
