/**
 * Kelta SDK Error Classes
 */

/**
 * Base error class for all Kelta errors
 */
export class KeltaError extends Error {
  constructor(
    ...
    Object.setPrototypeOf(this, KeltaError.prototype);
  }
}
 ...
 */
export class ValidationError extends KeltaError {
  constructor(
    message: string,
 ...
 */
export class AuthenticationError extends KeltaError {
 ...
 */
export class AuthorizationError extends KeltaError {
 ...
 */
export class NotFoundError extends KeltaError {
 ...
 */
export class ServerError extends KeltaError {
 ...
 */
export class NetworkError extends KeltaError {
  constructor(
    message: string,
...
export function parseErrorResponse(
  ...
  switch (statusCode) {
    ...
    default:
      ...
      return new KeltaError(message, statusCode);
  }
}

/**
 * Map an Axios error to the appropriate Kelta error class
 */
export function mapAxiosError(error: unknown): KeltaError {
  ...
  if (error instanceof Error) {
    return new KeltaError(error.message);
  }

  return new KeltaError('An unknown error occurred');
}
