 ...
 * <ul>
 *   <li>{@code kelta_worker_request_total} (counter) - total requests by collection, method, status</li>
 *   <li>{@code kelta_worker_request_duration_seconds} (timer/histogram) - request latency by collection</li>
 *   <li>{@code kelta_worker_error_total} (counter) - errors by collection and error type</li>
 * </ul>
 *
...
public class RequestMetricsFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            Counter.builder("kelta_worker_request_total")
            ...
            Timer.builder("kelta_worker_request_duration_seconds")
    ...
    private void recordError(String collectionName, String errorType) {
        Counter.builder("kelta_worker_error_total")
