 ...
 *
 * <p>A delegated-admin scope may not list a profile in {@code manageableProfileIds} or a
 * permission set in {@code assignablePermissionSetIds} that grants any of these — otherwise a
 * delegated admin could promote a user (or themselves, via a colluding account) into an
 * administrative role. Enforced twice: at scope save time by
...
public final class PrivilegedPermissions {
     ...
     *   <li>{@code MANAGE_GROUPS} — group membership feeds group-permission-sets.</li>
