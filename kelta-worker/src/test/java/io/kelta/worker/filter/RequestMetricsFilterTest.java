...
class RequestMetricsFilterTest {
    ...
    void shouldRecordMetricsForCollectionGetRequest() throws ServletException, IOException {
        ...
        Counter counter = meterRegistry.find("kelta_worker_request_total")
        ...
        // Verify timer
        Timer timer = meterRegistry.find("kelta_worker_request_duration_seconds")
                .tag("collection", "accounts")
                .tag("method", "GET")
                .timer();
    ...
    void shouldRecordErrorMetricsFor4xxResponse() throws ServletException, IOException {
        ...
        Counter errorCounter = meterRegistry.find("kelta_worker_error_total")
                .tag("collection", "accounts")
        ...
        Counter requestCounter = meterRegistry.find("kelta_worker_request_total")
    ...
    void shouldNotInstrumentNonCollectionRequests() throws ServletException, IOException {
        ...
        assertNull(meterRegistry.find("kelta_worker_request_total").counter(),
    ...
    void shouldTrackMultipleCollectionsSeparately() throws ServletException, IOException {
        ...
        Counter accountsCounter = meterRegistry.find("kelta_worker_request_total")
                .tag("collection", "accounts")
                .counter();
        assertNotNull(accountsCounter);
        assertEquals(2.0, accountsCounter.count(), "accounts should have 2 requests");

        Counter contactsCounter = meterRegistry.find("kelta_worker_request_total")
                .tag("collection", "contacts")
                .counter();
