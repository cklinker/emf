...
@DisplayName("CommentGuardHook Tests")
class CommentGuardHookTest {
    ...
    void rejectsCrossMemberDelete() {
        ...
        when(collectionRegistry.get("facility-comments")).thenReturn(definition);
    ...
    void allowsDeleteWhenCollectionMissing() {
        bindRequest("me@example.com");
        when(collectionRegistry.get("facility-comments")).thenReturn(null);
