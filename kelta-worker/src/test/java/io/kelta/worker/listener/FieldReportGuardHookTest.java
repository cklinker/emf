...
@DisplayName("FieldReportGuardHook Tests")
class FieldReportGuardHookTest {
    ...
    private FieldReportGuardHook hook;

    @BeforeEach
    void setUp() {
        hook = new FieldReportGuardHook(userIdResolver, collectionRegistry, queryEngine);
